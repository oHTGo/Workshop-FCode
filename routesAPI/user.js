...
/**
 * @api {get}                         /user             1. Get lists of user information
 * @apiGroup User
...
/**
 * @api {get}                         /user/topic           3. Get list topic of current user or get list all topic (if is admin)
 * @apiGroup User
 * @apiSuccess (Success) {String}     status                Status of request
 * @apiSuccess (Success) {Object[]}   message               Array of object request
 ...
 * @apiSuccess (Success) {Number}    object.status         Status of topic (0: waiting, 1: accept, -1: reject)
 *
 * @apiError (Error) {String} status      Status when complete
 * @apiError (Error) {String} message     Message when complete
 */
...
/**
 * @api {post}                       /user/topic/:topicId       4. Set status of topic (require is admin)
 * @apiGroup User
